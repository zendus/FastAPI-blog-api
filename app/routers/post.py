...
@router.get("/{id}", response_model=schemas.PostWithVoteAndComment)
...
current_user: int = Depends(oauth2.get_current_user)):
    ...
    post_with_vote = db.query(models.Post, func.count(models.Vote.post_id).label("Upvotes")).join(
    ...
    return {"detail": post_with_vote, "comments": comments}
